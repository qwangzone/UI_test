...
class CreateProTest(unittest.TestCase):
    ...
    @parameterized.expand([('test_project_name', 'project_name', 'project_name_t'),
                           ('test_project_status', 'project_status', 'project_name_t'),
                           ('test_project_category', 'project_category', 'project_name_t'),
                           ('test_projectNewType', 'projectNewType', 'project_name_t'),
                           ('test_financingMaturity', 'financingMaturity', 'project_name_t'),
                           ('test_corporeType', 'corporeType', 'project_name_t'),
                           ('test_amount', 'amount', 'project_name_t'),
                           ('test_minBidAmount', 'minBidAmount', 'project_name_t'),
                           ('test_repaymentCalcType', 'repaymentCalcType', 'project_name_t'),
                           ('test_interestRatePercent', 'interestRatePercent', 'project_name_t'),
                           ('test_displayIntere stRate', 'displayInterestRate', 'project_name_t'),
                           ('test_start_time', 'start_time', 'project_name_t'),
                           ('test_end_time', 'end_time', 'project_name_t'),
                           ('test_contractFullID', 'contractFullID', 'project_name_t'),
                           ('test_contractType', 'contractType', 'project_name_t'),
                           ('test_loanContract', 'loanContract', 'project_name_t'),
                           ('test_address', 'address', 'project_name_t'),
                           ('test_unicode', 'unicode', 'project_name_t'),
                           ('test_bondManId', 'bondManId', 'project_name_t'),
                           ('test_custRatingAAA', 'custRatingAAA', 'project_name_t'),
                           ('test_userName', 'userName', 'project_name_t'),
                           ('test_borrowerUserID', 'borrowerUserID', 'project_name_t'),
                           ('test_borrowerUserRealName', 'borrowerUserRealName', 'project_name_t'),
                           ('test_borrowerUserIDCard', 'borrowerUserIDCard', 'project_name_t'),
                           ('test_borrowerPayType', 'borrowerPayType', 'project_name_t'),
                           ('test_isrealborrower', 'isrealborrower', 'project_name_t'),
                           ('test_realBorrowerName', 'realBorrowerName', 'project_name_t'),
                           ('test_realBorrowerIdCard', 'realBorrowerIdCard', 'project_name_t'),
                           ('test_area', 'area', 'project_name_t'),
                           ('test_purpose', 'purpose', 'project_name_t'),
                           ('test_houseGuaranteeInfo', 'houseGuaranteeInfo', 'project_name_t'),
                           ('test_projectDescription', 'projectDescription', 'project_name_t'),
                           ('test_repaymentSource', 'repaymentSource', 'project_name_t'),
                           ('test_signAddr', 'signAddr', 'project_name_t'),
                           ])
